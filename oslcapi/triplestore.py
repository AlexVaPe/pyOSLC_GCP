...
def discover_service_providers(store):
    ...
    store.add((sp_catalog_uri, DCTERMS.title, Literal('GitHub OSLC Server')))
    store.add((sp_catalog_uri, DCTERMS.description, Literal('A server that provides OSLC capabilities to GitHub')))
